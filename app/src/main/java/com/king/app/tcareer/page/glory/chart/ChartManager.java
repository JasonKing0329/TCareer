package com.king.app.tcareer.page.glory.chart;
...
import com.king.app.tcareer.page.score.ChartStyle;
...
public class ChartManager {
    ...
    public void showLevelChart(PieChart chart, GloryTitle gloryTitle, boolean isWinner, boolean isCurrentYear) {
        ...
        contents[0] = AppConstants.RECORD_MATCH_LEVELS[0];
        contents[1] = AppConstants.RECORD_MATCH_LEVELS[1];
        contents[2] = AppConstants.RECORD_MATCH_LEVELS[2];
        contents[3] = AppConstants.RECORD_MATCH_LEVELS[3];
        contents[4] = AppConstants.RECORD_MATCH_LEVELS[4];
        contents[5] = AppConstants.RECORD_MATCH_LEVELS[6];
    ...
    public void showCourtChart(PieChart chart, GloryTitle gloryTitle, boolean isWinner, boolean isCurrentYear) {
        ...
        contents[0] = AppConstants.RECORD_MATCH_COURTS[0];
        contents[1] = AppConstants.RECORD_MATCH_COURTS[1];
        contents[2] = AppConstants.RECORD_MATCH_COURTS[2];
        contents[3] = AppConstants.RECORD_MATCH_COURTS[3];
