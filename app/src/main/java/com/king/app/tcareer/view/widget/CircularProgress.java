package com.king.app.tcareer.view.widget;
...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[4];
        mColors[0] = context.getResources().getColor(R.color.redC93437);
        mColors[1] = context.getResources().getColor(R.color.blue375BF1);
        mColors[2] = context.getResources().getColor(R.color.yellowF7D23E);
        mColors[3] = context.getResources().getColor(R.color.green34A350);
