 ...
 */
public class AtpWorldTourClient extends BaseHttpClient {

    private AtpWorldTourService atpWorldTourService;

    private AtpWorldTourClient() {
        super();
    }
    ...
    protected void createService(Retrofit retrofit) {
        atpWorldTourService = retrofit.create(AtpWorldTourService.class);
    }
    ...
    private static class SingletonHolder{
        private static final AtpWorldTourClient INSTANCE = new AtpWorldTourClient();
    }

    //获取单例
    public static AtpWorldTourClient getInstance(){
        return SingletonHolder.INSTANCE;
    }

    public AtpWorldTourService getService() {
        return atpWorldTourService;
    }
}
